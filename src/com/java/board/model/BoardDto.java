...
public class BoardDto {
	...
	public BoardDto(int boardNumber, String writer, String subject, String email, String content, String passowrd,
	...
	public String toString() {
		return "BoardDto [boardNumber=" + boardNumber + ", writer=" + writer + ", subject=" + subject + ", email=" + email
				+ ", content=" + content + ", passowrd=" + passowrd + ", writeDate=" + writeDate + ", readCount="
